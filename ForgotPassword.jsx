...
const ForgotPassword = () => {
  ...
  return (
    <div className="max-w-md mx-auto py-8 px-4 bg-[#EFFAF4]">
      <h2 className="text-2xl font-bold mb-4 text-[#145139]">Forgot Password</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full hover:bg-[#114330] transform transition-transform duration-200 hover:scale-105 bg-[#145139] text-[#EFFAF4] py-2 rounded"
          disabled={loading}
        >
